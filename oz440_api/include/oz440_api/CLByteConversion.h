...
cl::u8Array< 4 > float32_to_u8Array( const float value );

// uint8 to float conversions (little endian)
float u8Array_to_float32( const cl::u8Array< 4 >& arr );

// double to uint8 conversions (little endian)
cl::u8Array< 8 > float64_to_u8Array( const double value );

// uint8 to double conversions (little endian)
double u8Array_to_float64( const cl::u8Array< 8 >& arr );
