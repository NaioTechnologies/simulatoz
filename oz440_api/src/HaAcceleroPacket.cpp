...
//=============================================================================
//
HaAcceleroPacket::HaAcceleroPacket( )
{
...
//=============================================================================
//
HaAcceleroPacket::HaAcceleroPacket( int16_t x_, int16_t y_, int16_t z_  )
	: 	x{ x_ },
		y{ y_ },
		z{ z_ }
{
...
//=============================================================================
//
cl_copy::BufferUPtr HaAcceleroPacket::encode()
{
	uint cpt = 0;
...
//=============================================================================
//
void HaAcceleroPacket::decode( uint8_t *buffer, uint bufferSize )
{
