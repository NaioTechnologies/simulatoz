...
#ifndef VITALSEXPORT_HPP
#define VITALSEXPORT_HPP
...
/// C++ visibility support. See http://gcc.gnu.org/wiki/Visibility for more information
///
#ifdef DECL_SPEC
#define VITALS_EXPORT   __attribute__((visibility("default")))
#define VITALS_LOCAL    __attribute__((visibility("hidden")))
#else
#define VITALS_EXPORT
#define VITALS_LOCAL
#endif
