...
///
class VITALS_EXPORT Buffer : private util::NonCopyable< Buffer >
{
...
template< class... Args >
BufferSPtr VITALS_EXPORT shared_buffer( Args&& ... args )
{
	return std::make_shared< Buffer >( std::forward< Args >( args )... );
}

template< class... Args >
BufferUPtr VITALS_EXPORT unique_buffer( Args&& ... args )
{
