...
while beta < angle_fin :
    file.write("\t \t<include> \n \
\t \t \t <uri>model://%s</uri> \n \
\t \t \t <pose>%f %f 0.15 0 0 0</pose> \n \
\t \t \t <static>0</static> \n \
\t \t </include> \n \n" \
%(V, L * sin(beta) + 1.5 , - W/2 - ( 1 - cos(beta)) * L ))
    beta += alpha_int
...
\t \t \t <static>0</static> \n \
\t \t </include> \n \n" \
%( L * sin(beta) + 1.5 , - W/2 - ( 1 - cos(beta)) * L - 0.5))
...
\t \t \t <static>0</static> \n \
\t \t </include> \n \n" \
%(V, ( L + W ) * sin(beta) + 1.5 ,  W/2 - ( 1 - cos(beta)) * ( L + W ) ))
    beta += alpha_ext
...
\t \t \t <static>0</static> \n \
\t \t </include> \n \n" \
%( ( L + W ) * sin(beta) + 1.5 , W/2 - ( 1 - cos(beta)) * ( L + W ) - 0.5))
