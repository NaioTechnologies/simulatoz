...
Core::run()
{
    ...
    ros::Subscriber actuator_position_sub = node.subscribe( "/oz440/joint_states", 500, &Core::callback_actuator_position, this );
    ...
    message_filters::Subscriber< geometry_msgs::Vector3Stamped > gps_vel_sub( node, "/oz440/navsat/vel", 5 );
    ...
    message_filters::Subscriber< sensor_msgs::Image > image_left_sub( node, "/oz440/camera/left/image_raw", 1 );
    message_filters::Subscriber< sensor_msgs::Image > image_right_sub( node, "/oz440/camera/right/image_raw", 1 );
